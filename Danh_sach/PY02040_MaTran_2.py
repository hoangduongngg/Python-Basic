...
def Tong_Ma_Tran (a):
    ...
    return res
def Tong_Nua_Duoi (a):
    return Tong_Ma_Tran(a) - Tong_Nua_Tren(a) - Tong_DuongCheo_Phu(a)
def Ktra_CanDoi (a,k):
...
# Với đường chéo phụ, ta sẽ chia ma trận thành 2 nửa, được gọi là nửa trên và nửa dưới của 
# đường chéo phụ (không tính các phần tử nằm trên đường chéo phụ).
